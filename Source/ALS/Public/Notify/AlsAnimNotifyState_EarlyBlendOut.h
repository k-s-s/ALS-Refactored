...
public:
	...
	virtual void NotifyTick(USkeletalMeshComponent* MeshComponent, UAnimSequenceBase* Animation, float DeltaTim, const FAnimNotifyEventReference& EventReferencee) override;
};
